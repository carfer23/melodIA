    ...
    def generar_parametros_cielo(tipo_cielo):
        ...
        if tipo_cielo == "thunderstorm":
            parametros = {
                ...
                "velocidad_media": 0.7,
                "densidad_media": 0.8,
                "caracter_melodico": 0.35
            }
        elif tipo_cielo == "rainy sky":
            parametros = {
                "tonalidad_value": 0.25,
            "tempo": 80,
            "duracion_media": 1.75,
            "sigma": 0.7,
            "velocidad_media": 0.6,
        ...
        elif tipo_cielo == "bright sunny sky":
            parametros = {
                "tonalidad_value": 0.8,
                "tempo": 130,
                "duracion_media": 1.0,
                ...
                "velocidad_media": 0.8,
                "densidad_media": 0.55,
                "caracter_melodico": 0.65
            }
        elif tipo_cielo == "rainbow":
            parametros = {
                "tonalidad_value": 0.85,
                "tempo": 130,
                "duracion_media": 0.8,
                "sigma": 0.25,
                "velocidad_media": 0.85,
                "densidad_media": 0.55,
                "caracter_melodico": 0.65
            }
        elif tipo_cielo == "starry night":
            parametros = {
                "tonalidad_value": 0.35,
                "tempo": 70,
                "duracion_media": 2.25,
                "sigma": 0.75,
                "velocidad_media": 0.6,
                "densidad_media": 0.35,
                "caracter_melodico": 0.45
            }
        elif tipo_cielo == "clouds":
            parametros = {
                "tonalidad_value": 0.5,
                "tempo": 100,
                "duracion_media": 1.3,
                "sigma": 0.45,
                "velocidad_media": 0.65,
                "densidad_media": 0.45,
                "caracter_melodico": 0.45
            }
        elif tipo_cielo == "sunset":
            parametros = {
                "tonalidad_value": 0.65,
                "tempo": 110,
                "duracion_media": 1.3,
                "sigma": 0.4,
                "velocidad_media": 0.75,
                "densidad_media": 0.45,
                "caracter_melodico": 0.45
            }
        elif tipo_cielo == "snow":
            parametros = {
                "tonalidad_value": 0.25,
                "tempo": 80,
                "duracion_media": 1.05,
